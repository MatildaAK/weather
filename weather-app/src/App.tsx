...
import { UnitsProvider } from "./components/Context/UnitsContext";
...
const App = () => {
  ...
  const formatBackground = (weather: Weather | null, units: string): string => {
    ...
    if (weather.temp <= threshold)
      return "from-cyan-500 via-violet-500 to-blue-500";
  ...
  return (
    <>
      <div
        className={`text-white bg-gradient-to-t ${formatBackground(
          weather,
          units
        )}`}
      >
